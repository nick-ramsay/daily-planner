...
const PlanDetails = () => {
    ...
    */
    ...
    const exportDailyWork = (exportType) => {
        ...
        for (let i = 0; i < tempTasks.length; i++) {
            if (Number(tempTasks[i].hoursLogged) !== 0 || tempTasks[i].touched === true || moment(tempTasks[i].created_date).format("DD-MM-YYYY") === moment().format("DD-MM-YYYY")) {
                            ...
                            <div>
                                ...
                                <div className="accordion" id="planSettingsAccordion">
                                    <div>
                                        ...
                                        <div id="planSettingsCard" className="collapse" aria-labelledby="headingOne" data-parent="#planSettingsAccordion">
                                                ...
                                                <div className='row mt-2'>
                                                    ...
                                                    <div className='col-md-6'>
                                                        <div className="custom-control custom-switch">
                                                            <input type="checkbox" className="custom-control-input" defaultChecked={autoSort} id="autoSortSwitch" onClick={() => { autoSort === true ? setAutoSort(false) : setAutoSort(true); }} />
                                                            <label className="custom-control-label" htmlFor="autoSortSwitch">Auto Sort</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className='row mt-2'>
                                                                                                    ...
                                                                                                    <div className="col-md-12 text-left">
                                                                                                        {
                                                                                                            task.links !== undefined ? task.links.map(
                                                                                                                (link, j) =>
                                                                                                                    <div key={"task-" + i + "-link-" + j} className="mt-1">
