...
export default {
    ...
    updateTask: function (planID, taskDescription, taskArrayPosition, newHoursLogged, newStatus, newTaskDescription, newLinks, touched) {
        return axios({ method: "post", url: apiURL + "/api/daily-planner/update-task", data: { planID, taskDescription, taskArrayPosition, newHoursLogged, newStatus, newTaskDescription, newLinks, touched } })
    },
